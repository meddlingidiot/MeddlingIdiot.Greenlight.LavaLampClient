...
/// <summary>How much of the screen the lamp is allowed to stand on.</summary>
public enum AreaChoice
{
    /// <summary>
    /// The desktop as far as the taskbar. A lamp dragged to the bottom of the screen still
...
/// <summary>
/// Works out the rectangle the overlay covers. Unlike the cars, the lamp is not attached to
/// anything — it stands wherever it was put — so this is only ever asked for the bounds of
/// the desktop.
/// </summary>
...
public static class DesktopArea
{
    ...
    public static AreaBounds Find(AreaChoice choice)
    {
        ...
        // second monitor instead of cutting the lamp off at the edge of the first.
