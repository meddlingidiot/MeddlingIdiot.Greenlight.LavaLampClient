...
/// <summary>
/// Whether the lamp comes back when Windows does. One value under the current user's
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Lava Lamp";

    /// <summary>Whether Windows is currently set to start the lamp.</summary>
    ...
    /// <summary>Ask Windows to start the lamp, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.LavaLampClient\current\Greenlight.LavaLampClient.exe</c>,
